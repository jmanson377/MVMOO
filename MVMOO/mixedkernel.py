...
###############################################################################
class Mixed(gpf.kernels.Kernel):
    """
    Base class for mixed variable kernel classes.
...
###############################################################################
class MixedMatern52(Mixed):
    """
    The Mixed Matern 5/2 kernel. Functions drawn from a GP with this kernel are twice
    differentiable. The kernel equation is

    k(r) = σ² (1 + √5r + 5/3r²) exp{-√5 r}

    where:
    r  is the Gower distance between the input points, scaled by the lengthscales parameter ℓ,
...
class MixedMatern32(Mixed):
    """
    The Mixed Matern 3/2 kernel. Functions drawn from a GP with this kernel are once
    differentiable. The kernel equation is
...
class MixedSqExp(Mixed):
    """
    The mixed radial basis function (RBF) or mixed squared exponential kernel. The kernel equation is
